...
---
### Decorators usually extends or alters the behavior of the original function.
---
...
- Decorators provide a powerful way to extend the behavior of functions or methods without directly modifying their code
